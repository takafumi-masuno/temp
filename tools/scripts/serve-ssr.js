/**
 * 指定されたアプリをssrビルド＆起動します。
 *
 * Usage: node serve-ssr.js <projectName> <environment>
...
if (process.argv.length > 4 || process.argv.length < 3) {
  ...
  console.log(
    '    at-rent-office, at-rent-store, at-rent-parking, at-rent-tochi, at-rent-souko, at-rent-other, at-buy-store, at-buy-office, at-buy-other, at-estate,at-resort'
  );
  console.log(
